...
You will need your own [Anthropic API key](https://console.anthropic.com). The key stays private to your deployment, and your data never touches anyone else's server.
